...
@pytest.fixture
def teacher(client: TestClient, token: str):
...
def test_delete_teacher_not_found(client: TestClient, token: str):
...
def test_update_teacher_not_found(client: TestClient, token: str):
